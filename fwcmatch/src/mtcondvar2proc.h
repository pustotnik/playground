...
class MTCondVar2Processor final: public BaseMTProcessor
{
public:
    MTCondVar2Processor(size_t queueSize, size_t numOfConsThreads, size_t maxLines);
...
inline size_t MTCondVar2Processor::calcFinalResult() const {
